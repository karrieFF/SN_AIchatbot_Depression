...
[![CRAN status](https://www.r-pkg.org/badges/version/doipkg)](https://CRAN.R-project.org/package=doipkg) [![R-CMD-check.yaml](https://github.com/karrieFF/SN_AIchatbot_Physical_Activity/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/karrieFF/SN_AIchatbot_Physical_Activity/actions/workflows/R-CMD-check.yaml) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/karrieFF/SN_AIchatbot_Physical_Activity/blob/main/LICENSE.md)
...
You can install the development version of doipkg from [GitHub](https://github.com/) with:
...
This example is to run social network simulation to determine which approach for selecting innovators can help achieve large effectiveness.
...
This function helps you calculate the distance between two agents based on the agents' characteristics.
...
This function helps you output the change of outcome after the social network intervention.
