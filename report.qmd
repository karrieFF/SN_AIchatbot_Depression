...
**Step 3. Calculate the follow-up physical activity and measure the change of physical activity using t-test**
...
Then, the follow-up physical activity status were calculated accordingly. Finally, t-test was used measure if the change in physical activity is statistically significant or not.

![](images/clipboard-3370989202.png){fig-align="center" width="283"}

**Step 4. Compare the results of different approaches to calculate centrality**

Then, the efficacy of changing in physical activity was compared using three approaches (i.e., Count, Betweeness, Closeness). For each approach, 1000 simulations was conducted, and the final results were the average results of those 1000 simulations.

**Step 5. Visualize the network with baseline physical activity and follow-up physical activity**
...
**6. Visualize the diffusion process**
...
1.  time is also a factor, consider the day-level diffusion

## References

Oracle Corporation (2016) <https://www.oracle.com/webfolder/s/delivery_production/docs/FY16h1/doc35/CXResearchVirtualExperiences.pdf>
